...
from nvidia_tao_tf1.core.processors import RandomTranslation as _RandomTranslation


class RandomTranslation(TransformProcessor):
    """Augmentation processor that randomly translates images and labels."""

    @save_args
    def __init__(self, max_x, max_y, probability=1.0):
        ...
        super(RandomTranslation, self).__init__(
            _RandomTranslation(max_x, max_y, probability)
        )
