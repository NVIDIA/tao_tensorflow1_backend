...
"""Processor that scales images and labels."""
...
from nvidia_tao_tf1.core.processors import Scale as _Scale


class Scale(TransformProcessor):
    """Processor for scaling images and labels."""
    ...
    def __init__(self, height, width):
        ...
        """
        super(Scale, self).__init__(_Scale(height=height, width=width))
